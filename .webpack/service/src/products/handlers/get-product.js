...
/***/ "./src/products/handlers/get-product.ts":
/*!**********************************************!*\
  !*** ./src/products/handlers/get-product.ts ***!
  \**********************************************/
...
/* harmony import */ var _utils_http_response__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/http-response */ "./src/utils/http-response.ts");
/* harmony import */ var _utils_http_status_code_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/http-status-code.enum */ "./src/utils/http-status-code.enum.ts");
/* harmony import */ var _utils_validate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/validate */ "./src/utils/validate.ts");
/* harmony import */ var _product_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../product.service */ "./src/products/product.service.ts");
...
const schema = joi__WEBPACK_IMPORTED_MODULE_1__["object"]({ id: joi__WEBPACK_IMPORTED_MODULE_1__["string"]().required() });
const handler = (event) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function* () {
    try {
        const { error, value } = Object(_utils_validate__WEBPACK_IMPORTED_MODULE_4__["validate"])(schema, event.pathParameters);
        if (error) {
            return new _utils_http_response__WEBPACK_IMPORTED_MODULE_2__["HttpResponse"](_utils_http_status_code_enum__WEBPACK_IMPORTED_MODULE_3__["HttpStatusCode"].BAD_REQUEST, error);
        }
        else {
            const product = yield _product_service__WEBPACK_IMPORTED_MODULE_5__["productService"].findOne(value.id);
            if (product) {
                return new _utils_http_response__WEBPACK_IMPORTED_MODULE_2__["HttpResponse"](_utils_http_status_code_enum__WEBPACK_IMPORTED_MODULE_3__["HttpStatusCode"].OK, product);
            }
            return new _utils_http_response__WEBPACK_IMPORTED_MODULE_2__["HttpResponse"](_utils_http_status_code_enum__WEBPACK_IMPORTED_MODULE_3__["HttpStatusCode"].NOT_FOUND);
        }
    }
    catch (error) {
        return new _utils_http_response__WEBPACK_IMPORTED_MODULE_2__["HttpResponse"](_utils_http_status_code_enum__WEBPACK_IMPORTED_MODULE_3__["HttpStatusCode"].INTERNAL_SERVER_ERROR, error);
    }
});
